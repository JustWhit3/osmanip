...
namespace osm {
    ...
    /**
     * @brief Removes all leading and trailing
     * spaces from a string.
     *
     * @param str the string to be trimmed.
     *
     * @return string with no leading or tailing
     * spaces.
     *
     */
    std::string trim_string(const std::string &str) {
        ...
        res = last + 1 == std::string::npos ? res.substr(first) : res.substr(first, (last + 1) - first);
        return res;
    }
     ...
     * alphabetic character in the str, starting
     * from the given position.
     *
     * @param str the string be searched.
     * @param pos the starting position.
     *
     * @return the index of the alpha char if
     * successful, otherwise std::string::npos.
     *
     */
    ...
    /**
     * @brief Formats a string according to the
     * ANSI (Control Sequence Introducer) escape
     * sequences present within the string. Can be
     * used in a loop with appending data by using
     * optional arguments.
     *
     * @param str the string to be formatted.
     * @param last_pos [Optional] the final
     * position (index) of the last string to be
     * formatted.
     * @param last_size [Optional] the size of the
     * last string to be formatted.
     *
     * @return a correctly formatted string, free
     * of any ANSI escape sequences.
     *
     */
    std::string get_formatted_from_ansi(const std::string &str, int32_t *last_pos, int32_t *last_size) {
        ...
        // Get the most recently formatted string
        // (if available)
        ...
        for (; src_crsr_pos < (int32_t)str.size(); ++src_crsr_pos) {
            ...
            if (ch.front() == '\033') {
                // Extract the ansi escape
                // sequence from str and move past
                // it
                ...
                if (csi_str.empty()) {
                    ...
                    // Move past the CSI and
                    // handle it in the res string
    ...
    // get_ansi_csi_string
    /**
     * @brief Returns the ANSI CSI (Control
     * Sequence Introducer) in the string
     * beginning at the given position (if
     * present).
     *
     * @example   | 'ESC' | '[' | 'n' |  'code'  |
     *
     * @param str the string containing the ANSI
     * CSI.
     * @param esc_pos the index of the
     * escape_sequence in the string.
     *
     * @return a string of the ANSI CSI if found,
    ...
    // get_ansi_csi_number
    /**
     * @brief Returns the number (n) of the ANSI
     * CSI (Control Sequence Introducer) string.
     *
     * @example   | 'ESC' | '[' | 'n' |  'code'  |
     *
     ...
     * is not an ANSI CSI.
     *
     * @return the number of the ANSI CSI if
     * found.
     *
     */
    [[maybe_unused]] int32_t get_ansi_csi_number(const std::string &csi) {
        ...
        if (n_pos < csi.size()) {
            // Verify the value after the bracket
    ...
    // get_ansi_csi_code
    /**
     * @brief Returns the command code of the ANSI
     * CSI (Control Sequence Introducer) string.
     *
     * @example   | 'ESC' | '[' | 'n' |  'code'  |
     *
     ...
     * is not an ANSI CSI.
     *
     * @return the code of the ANSI CSI if found.
     * Otherwise, returns a null terminator.
     *
     */
    ...
    // handle_csi
    /**
     * @brief Given a string of an ANSI CSI
     * (Control Sequence Introducer), this
     * function will execute the CSI and correctly
     * modify the destination string and update
     * the current position.
     *
     * @cite Documentation from
     * https://en.wikipedia.org/wiki/ANSI_escape_code
     *
     * @param csi_str a string of the ANSI CSI
     * @param dst_str the destination string to
     * modify
     * @param dst_crsr_pos the current position
     * (index) of the destination string
     *
     */
    [[maybe_unused]] void handle_csi(const std::string &csi_str, std::string &dst_str, int32_t *dst_crsr_pos) {
        ...
        switch (code) {
                /**
                 * @brief Moves the cursor n
                 * (default 1) cells in the given
                 * direction. If the cursor is
                 * already at the edge of the
                 * screen, this has no effect.
                 *
                 * @examples ESC[nA, ESC[nB,
                 * ESC[nC, ESC[nD
                 *
                 */
            case 'A': {
            ...
            case 'D': {
                // "ESC[100D" is not always enough
                // to return to the edge of the
                // screen, so guarantee it by
                ...
                /**
                 * @brief If n is 0 (or missing),
                 * clear from cursor to end of
                 * screen. If n is 1, clear from
                 * cursor to beginning of the
                 * screen. If n is 2 or 3, clear
                 * entire screen.
                 *
                 * @example ESC[nJ
                 *
            ...
            case 'J': {
                ...
                /**
                 * @brief If n is 0 (or missing),
                 * clear from cursor to the end of
                 * the line. If n is 1, clear from
                 * cursor to beginning of the
                 * line. If n is 2, clear entire
                 * line. Cursor position does not
                 * change.
                 *
                 * @example ESC[nK
                 *
