...
namespace osm {
    ...
    /**
     * @brief Construct a new Canvas:: Canvas object. The size of the canvas in
     * characters must be specified upon construction.
     *
    ...
    // enableFrame
    /**
     * @brief Flag to frame or not the canvas. The frame doesn't increase the
     * size taken by the canvas. Instead, reduces the 2D space to draw in two
     * columns and two rows (used to print the frame itself).
     *
     * @param frame_enabled Set to True to enable the frame. Otherwise set to
     * False.
     */
    ...
    // put
    /**
     * @brief Put a character in the canvas, given its coordinates and an
     * optional feat. An out-of-bounds exception will be thrown if the
