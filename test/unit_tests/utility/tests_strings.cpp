...
TEST_CASE("Testing the strings utilities") {
    ...
    //   {
    //     std::string csi_string = "\u001b[2TThis \u001b[1Sis\u001b[0K a
    //     \u001b[33mstring"; std::string formatted_string =
    //     osm::get_formatted_string( csi_string ); std::string normal_string =
    //     "This is a string"; CHECK_NE( formatted_string, csi_string );
    ...
    //
    //     lorem_ipsum_str = "Lorem ipsum dolor sit amet, consectetur
    //     adipiscing\n elit, sed do eiusmod tempor incididunt "
    //                       "ut labore et dolore magna aliqua. Fermentum et
    //                       sollicitudin ac orci phasellus. Ut tortor "
    //                       "pretium viverra suspendisse. Nunc aliquet bibendum
    //                       enim facilisis gravida neque convallis " "a
    //                       cras.\nPellentesque dignissim enim sit amet
    //                       venenatis urna. At lectus urna duis convallis.";
    //
