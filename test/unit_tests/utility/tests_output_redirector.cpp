...
void test_perc_bars();
void test_load_bars();
void test_mixed_bars();
void test_progress_spinner();

//====================================================
//     Testing OutputRedirector class
//====================================================
TEST_CASE("Testing OutputRedirector class") {
    std::string default_filename = osm::redirout.getFilename();
    ...
    SUBCASE("Testing touch method.") {
        CHECK_EQ(file_exists(osm::redirout.getFilename()), false);

        osm::redirout.touch();

        CHECK_EQ(file_exists(osm::redirout.getFilename()), true);
        CHECK_EQ(find_file(osm::redirout.getFilename()), default_filepath);
        CHECK_EQ(delete_file(osm::redirout.getFilename()), true);
        CHECK_EQ(file_exists(osm::redirout.getFilename()), false);

        osm::redirout.setFilename(TEST_FILENAME);

        CHECK_EQ(file_exists(osm::redirout.getFilename()), false);

        osm::redirout.touch();

        CHECK_EQ(find_file(osm::redirout.getFilename()), test_filepath);
        CHECK_EQ(delete_file(osm::redirout.getFilename()), true);
        CHECK_EQ(file_exists(osm::redirout.getFilename()), false);
    }
    ...
    SUBCASE("Testing begin, flush, and end methods.") {
        CHECK_THROWS_AS(osm::redirout.end(), std::runtime_error);

        CHECK_NOTHROW(osm::redirout.begin());
        CHECK_THROWS_AS(osm::redirout.begin(), std::runtime_error);

        CHECK_NOTHROW(osm::redirout.end());
        CHECK_THROWS_AS(osm::redirout.end(), std::runtime_error);
    }

    delete_file(osm::redirout.getFilename());
    ...
    //     osm::redirout.end();
    //
    //     std::string file_contents = read_file( osm::redirout.getFilename() );
    //
    //     CHECK_EQ( file_contents, test_redirection_str );
    //     CHECK_NE( file_contents, "Not equal to " + test_redirection_str );
    //
    //     std::ofstream cleared_file( osm::redirout.getFilename(),
    //     std::fstream::trunc | std::fstream::out );
    //
    //     CHECK_EQ( cleared_file.is_open(), true );
    //     cleared_file.close();
    //     file_contents = read_file( osm::redirout.getFilename() );
    //
    //     CHECK_EQ( file_contents, "" );
    //
    //     std::string lorem_ipsum_str = "Lorem ipsum dolor sit amet,
    //     consectetur adipiscing elit, sed do eiusmod tempor incididunt "
    //                                   "ut labore et dolore magna aliqua.
    //                                   Fermentum et sollicitudin ac orci
    //                                   phasellus. Ut tortor " "pretium viverra
    //                                   suspendisse. Nunc aliquet bibendum enim
    //                                   facilisis gravida neque convallis " "a
    //                                   cras.\nPellentesque dignissim enim sit
    //                                   amet venenatis urna. At lectus urna
    //                                   duis convallis."
    ...
    //                                   scelerisque.Ut placerat orci nulla
    //                                   pellentesque.";
    //
    //     osm::redirout.begin();
    ...
    //                               "100% \n"
    //                               "\n"
    //                               "This is a percentage bar with message and
    //                               the /100 style: \n" "100/100 processing...
    //                               \n"
    //                               "\n"
    //                               "This is a percentage bar with time
    //                               consuming info: \n" "100% \n"
    //                               "\n"
    //                               "This is a percentage bar with
    //                               time-remaining info: \n" "100% [Estimated
    //                               time left: 0m 0s]\n\n";
    //
    //     std::string file_contents = read_file( osm::redirout.getFilename() );
    ...
    //                               \n"
    //                               "\n"
    //                               "This is a loading bar with time-remaining
    //                               info: \n"
    //                               "{#########################} [Estimated
    //                               time left: 0m 0s]\n\n";
    //
    ...
    //                               elaborating... \n"
    //                               "\n"
    //                               "This is a mixed progress bar with color
    //                               and time remaining info: \n"
    //                               "[■■■■■■■■■■■■■■■■■■■■■■■■■] 100%
    //                               elaborating... [Estimated time left: 0m
    //                               0s]\n"
    //                               "\n"
    //                               "This is a mixed progress bar with two
    //                               customized styles: \n"
    //                               "[>>>>>>>>>>>>>>>>>>>>>>>>>] 100|100
    //                               elaborating... \n\n";
    //
...
void test_perc_bars() {
    ...
    osm::cout << "This is a normal percentage bar: "
              << "\n";
    for (int32_t i = percentage_bar.getMin(); i < percentage_bar.getMax();
         i++) {
